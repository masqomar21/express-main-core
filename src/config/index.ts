...
export const CONFIG = {
  ...
  saveToBucket: process.env.FILE_SAVE_TO_BUCKET
    ? process.env.FILE_SAVE_TO_BUCKET === 'true'
    : false,
  s3: {
    ...
    useAccelerateEndpoint : process.env.S3_USE_ACCELERATE_ENDPOINT === 'true' || false,
  },
